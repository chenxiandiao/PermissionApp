package com.teletraan.permission.util;
...
import com.teletraan.permission.menu.DefaultStartSettings;
import com.teletraan.permission.menu.IMenu;
import com.teletraan.permission.menu.OPPOStartSettings;
import com.teletraan.permission.menu.VIVOStartSettings;
    ...
    public static void invokeAnnotation(Object object, Class annotationClass, int requestCode) {
        ...
        for (Method method : methods) {
            ...
            if (annotationPresent) {
                PermissionCancel annotation = (PermissionCancel) method.getAnnotation(annotationClass);
                if (annotation != null) {
